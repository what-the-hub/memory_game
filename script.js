class MatchGrid {
  ...
  addGridItemsEventListener() {
    document
      .getElementById('grid')
      .addEventListener('click', this.boundHandleCardClick)
  }

  removeGridItemsEventListener() {
    document
      .getElementById('grid')
      .removeEventListener('click', this.boundHandleCardClick)
  }
  ...
  handleCardFlip(card, isFlipped) {
    ...
    card.flipped
      ? cardElement.setAttribute('class', `${this.theme}--open`)
      : cardElement.setAttribute('class', `${this.theme}`)
  }
  ...
  checkForMatch() {
    if (this.flipped.length === 2) {
      ...
      if (card1.value === card2.value) {
        ...
        this.flipped = []
        this.animateMatchedCards([card1, card2])
